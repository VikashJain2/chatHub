                    ...
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-sm font-medium text-gray-900">
                        {notification.type === 'sent' &&
                          `Sent invitation to ${notification.firstName + ' ' + notification.lastName}`}
                        {notification.type === 'received' &&
                          `Received invitation from ${notification.firstName + ' ' + notification.lastName}`}
                        {notification.type === 'accepted' &&
                          `${notification.firstName + ' ' + notification.lastName} accepted your invitation`}
                      </span>
                    </div>
